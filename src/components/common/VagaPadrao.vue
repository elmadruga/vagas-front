<template>
    <div class="card">
        ...
        <div class="card-footer">
            <small class="text-muted">Salário: {{ salario }} | Modalidade: {{ getModalidade }} | Tipo: {{ getTipo }} | Publicação:
                {{ getPublicacao }}</small>
        </div>
    </div>
</template>
...
export default {
    ...
    props: {
        ...
        descricao: {
            type: String,
            required: true,
            default: 'O contratente não adicionou uma descrição para esta vaga'
        },
        salario: {
            type: [ Number, String ],
            required: true
